...
const Header = ({ onResetToStartingView, onOpenProjectMenu }) => {
  ...
  const handleMobileNavItemClick = (itemId) => {
    // If clicking the currently active item, reset to starting view
    if (activeMobileNavItem === itemId && onResetToStartingView) {
      onResetToStartingView();
    ...
    if (itemId === 'settings') {
      setShowSettingsMenu(true);
    } else if (itemId === 'projects' && onOpenProjectMenu) {
      onOpenProjectMenu();
    }
        ...
        <div className="header__actions">
          ...
          <ProfileIcon />
                  ...
                  <div className="profile-menu">
                    ...
                    {/* Admin Tool in Profile Menu - Only for Admin Users */}
                    {isAdmin && (
                      <button className="profile-menu-item" onClick={handleAdminToolClick}>
